                ...
                @auth
                    <li>
                        <form action="/logout" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="text-slate-500 hover:text-indigo-600 font-semibold" style="background:none; border:none; cursor:pointer; font-size:0.95rem;">Logout</button>
                        </form>
                    </li>
                @else
